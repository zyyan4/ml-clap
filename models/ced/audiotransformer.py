...
from models.ced.checkpoints import register_model, build_mdl
from models.ced.layers import AudioPatchEmbed, DropPath, Mlp, trunc_normal_, to_2tuple
...
class AudioTransformer(nn.Module):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super().__init__()
        assert pooling in ('mean', 'token', 'dm', 'logit', 'cat')
